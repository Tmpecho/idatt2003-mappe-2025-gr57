...
public interface Tile {
  /**
   * Returns a list of adjacent tiles. - In Snakes and Ladders, this might be just the “next” tile
   * (plus any jump if there’s a snake or ladder). - In Cluedo, this might be up to 4 neighboring
   * hallway tiles or a door tile leading into a room.
   */
  ...
  /**
   * Whether a player is allowed to enter or exit this tile (e.g., a wall or locked room might
   * disallow entry).
   */
