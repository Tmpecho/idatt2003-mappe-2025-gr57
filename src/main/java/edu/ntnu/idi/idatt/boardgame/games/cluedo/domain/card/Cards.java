...
/**
 * Utility class providing access to Cluedo card information and deck creation.
 * This class defines the standard sets of suspects, weapons, and rooms.
...
public final class Cards {
  ...
  /**
   * Creates a fully shuffled deck of Cluedo cards.
   * This deck includes all suspect, weapon, and room cards.
   * The solution cards (case file) are typically removed from this deck *after* generation
