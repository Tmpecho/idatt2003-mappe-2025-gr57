...
/**
 * Represents the visual view of a single tile on the Snakes and Ladders board. Implements {@link
 * TileObserver} to update its display when the underlying tile model changes.
 */
